...
export declare const FROAM_PROJECT_SCHEMA_VERSION: 1;
...
export type FroamRelationKind = 'contains' | 'instance-of' | 'navigates-to' | 'transitions-to' | 'uses-asset' | 'derived-from' | 'custom';
...
export type FroamProjectEventType = 'design.store.replaced' | 'design.op.appended' | 'node.upserted' | 'node.removed' | 'relation.upserted' | 'relation.removed' | 'flow.upserted' | 'flow.removed' | 'interaction.upserted' | 'interaction.removed' | 'dna.captured' | 'asset.upserted' | 'asset.removed';
