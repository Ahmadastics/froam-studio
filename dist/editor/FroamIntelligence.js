...
export default function FroamIntelligence(props) {
    ...
    return _jsxs(_Fragment, { children: [_jsxs("aside", { className: "froam-intelligence", "data-chef-editor-root": "true", children: [_jsxs("header", { children: [_jsxs("div", { children: [_jsx("strong", { children: "Understand" }), _jsx("small", { children: "Local interface evidence" })] }), _jsx("button", { type: "button", "aria-label": "Close Understand tools", onClick: () => { props.onPreviewWidth(null); props.onClose(); }, children: _jsx(X, { size: 15 }) })] }), _jsx("nav", { children: tabs.map(([id, label, Icon]) => _jsxs("button", { type: "button", className: tab === id ? 'is-active' : '', title: label, onClick: () => { if (tab === 'responsive')
