...
export default function GlobalChefEditor({ initialOpen = false, routeKey: explicitRouteKey }) {
    ...
    return createPortal(_jsxs(_Fragment, { children: [_jsxs("button", { className: [
                ...
                }, onToast: showToast }), showPanel && selection && !inlineEditing && (_jsx(FroamResizeHandles, { targetRect: selectionRect, visible: !!selectionRect, onResizeStart: () => {
                    if (!selection)
                        return;
