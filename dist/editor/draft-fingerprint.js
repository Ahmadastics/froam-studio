 ...
 */
export function fingerprintForDraft(element, root, originalText) {
    ...
    if (original)
        ...
        delete fingerprint.text;
    return fingerprint;
}
//# sourceMappingURL=draft-fingerprint.js.map