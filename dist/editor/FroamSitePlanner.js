...
import { ArrowDown, ArrowUp, Check, ChevronRight, Copy, FilePlus2, Frame, Grid2X2, Heart, LayoutTemplate, ListTree, Network, Plus, RefreshCw, Search, Sparkles, Trash2, } from 'lucide-react';
...
export default function FroamSitePlanner({ routeKey, projectName, branchName, selection, archiveItems, onInsertComponent, onInsertBlankFrame, onInsertBlock, onInsertArchived, onBuildPage, onPlanChange, onToast }) {
    ...
    return (_jsxs("div", { className: "fsp", "data-chef-editor-root": "true", children: [_jsxs("header", { className: "fsp-context", children: [_jsxs("div", { className: "fsp-context__project", children: [_jsx(Network, { size: 14 }), _jsxs("span", { children: [_jsx("strong", { children: projectName }), _jsxs("small", { children: [branchName, " \u00B7 ", routeKey] })] }), _jsx("em", { children: "Graph synced" })] }), _jsxs("div", { className: `fsp-context__selection ${selection ? 'has-selection' : ''}`, children: [_jsx("span", { children: selection ? 'Insert relative to' : 'Canvas target' }), _jsx("strong", { children: selection?.label ?? 'Page end' }), selection?.nodeId && _jsx("small", { title: selection.nodeId, children: "stable ID" })] })] }), _jsxs("div", { className: "fsp-tabs", role: "tablist", "aria-label": "Froam planning tools", children: [_jsxs("button", { type: "button", className: tab === 'blueprint' ? 'is-active' : '', onClick: () => setTab('blueprint'), children: [_jsx(Frame, { size: 14 }), " Draft"] }), _jsxs("button", { type: "button", className: tab === 'sitemap' ? 'is-active' : '', onClick: () => setTab('sitemap'), children: [_jsx(ListTree, { size: 14 }), " Pages"] }), _jsxs("button", { type: "button", className: tab === 'wireframe' ? 'is-active' : '', onClick: () => setTab('wireframe'), children: [_jsx(LayoutTemplate, { size: 14 }), " Compose"] }), _jsxs("button", { type: "button", className: tab === 'library' ? 'is-active' : '', onClick: () => setTab('library'), children: [_jsx(Grid2X2, { size: 14 }), " Add"] })] }), tab === 'blueprint' && (_jsxs("div", { className: "fsp-pane", children: [_jsxs("div", { className: "fsp-prompt-planner", children: [_jsxs("div", { className: "fsp-flow-rail", "aria-label": "Froam planning flow", children: [_jsx("span", { className: "is-active", children: "1 Describe" }), _jsx("span", { children: "2 Organize" }), _jsx("span", { children: "3 Build" })] }), _jsxs("label", { className: "fsp-prompt-box", children: [_jsx("span", { children: "What are you trying to make?" }), _jsx("textarea", { value: planningPrompt, onChange: (event) => setPlanningPrompt(event.target.value), placeholder: "Example: A premium homepage that makes visitors trust the product in the first five seconds \u2014 clear promise, proof, and one obvious next step...", rows: 4 })] }), _jsx("div", { className: "fsp-preset-row", children: BLUEPRINT_PRESETS.map((preset) => (_jsx("button", { type: "button", onClick: () => {
