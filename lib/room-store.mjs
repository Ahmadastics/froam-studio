 ...
 */
export function createFroamRoomApi({ file, storage, authorize = null, onApproveRequest = null, log = () => {}, now = () => Date.now() }) {
  ...
  return async function handleRoomRequest(req, res) {
    ...
    if (action === 'chat') {
      ...
      if (method === 'POST') {
        ...
        const message = { id: randomUUID(), actor: member.actor, name: member.name, body, createdAt: now(), ...(requestId ? { requestId } : {}) }
