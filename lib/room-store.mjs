 ...
 *
 * Presence is what decides whether a review link follows the designer or just
 * shows the design, so this is a product decision as much as a technical one:
 * long enough to survive a tunnel or a lock screen, short enough that a closed
